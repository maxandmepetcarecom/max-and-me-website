...
export default function Home() {
  ...
  return (
    <div style={{ background: '#f0e8d5', minHeight: '100vh', fontFamily: "'Outfit', sans-serif" }}>
      ...
      {/* ── NAVIGATION (inside hero, scrolls with page) ── */}
      <header style={{ position: 'absolute', top: 0, left: 0, right: 0, zIndex: 100 }}>
        {/* Gradient dark bg for nav */}
        <div style={{
        ...
        {/* Logo — anchored in hero, scrolls with page */}
        <a href="#" style={{ position: 'absolute', top: 36, left: 'clamp(24px, 5vw, 80px)', zIndex: 10, textDecoration: 'none', display: 'block' }}>
          <img src={logoImg} alt="Max & Me Pet Care" style={{ height: 160, width: 'auto', display: 'block', mixBlendMode: 'screen' }} />
        </a>
        ...
        {/* Bottom fade for card transition */}
        <div style={{
          position: 'absolute',
          inset: 0,
      ...
      <section style={{ position: 'relative', zIndex: 10, marginTop: -90 }}>
        <div className="cards-row" style={{ display: 'flex', position: 'relative' }}>
          ...
          {/* ── LEFT CARD: Canine Adventure Club ── */}
          <div className="card-left" style={{
            ...
            {/* Mountain icon — centered above content */}
          ...
          <div className="card-right" style={{
            ...
            {/* House icon — centered above content */}
            <div style={{ marginBottom: 24 }}>
              <HomeHeartIcon />
            </div>
        ...
        {/* Torn paper edge to cream section */}
        <TornBottom fill="#f0e8d5" />
      </section>


      {/* ══════════════════════════════════════════════════════
          ABOUT — MEET RAMONA & MAXIMUS
      ══════════════════════════════════════════════════════ */}
      <section id="about" style={{ background: '#f0e8d5', padding: 'clamp(56px, 8vw, 96px) clamp(24px, 6vw, 84px)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: 'minmax(0, 0.9fr) minmax(0, 1.1fr)', gap: 'clamp(36px, 6vw, 72px)', alignItems: 'center' }} className="about-grid">
          <div style={{ position: 'relative' }}>
            <div style={{ borderRadius: 24, overflow: 'hidden', border: '5px solid #152638', boxShadow: '0 18px 40px rgba(21,38,56,0.16)' }}>
              <img src={aboutImg} alt="Ramona with dogs from the Max & Me pack" style={{ width: '100%', display: 'block', aspectRatio: '4 / 3', objectFit: 'cover', objectPosition: 'center 35%' }} />
            </div>
            <div style={{ position: 'absolute', right: -14, bottom: -18, background: '#e8631a', color: 'white', borderRadius: 999, width: 76, height: 76, display: 'flex', alignItems: 'center', justifyContent: 'center', border: '5px solid #f0e8d5', boxShadow: '0 8px 24px rgba(0,0,0,0.16)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: 10, color: '#152638', fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '1.15rem', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
      ...
      {/* ══════════════════════════════════════════════════════
          TRUST BADGES — CREAM SECTION
      ══════════════════════════════════════════════════════ */}
      <section style={{ background: '#f0e8d5', position: 'relative', overflow: 'hidden', padding: '40px 32px 48px' }}>
        ...
        {[
          ...
          <div key={i} style={{
            ...
            right: (m as any).right, bottom: (m as any).bottom,
            opacity: m.opacity,
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '0.95rem', letterSpacing: '0.06em', color: '#1a2d4a', lineHeight: 1.3, margin: 0 }}>
              INSURED &amp;<br />BONDED
            </p>
          </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <p style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: '0.95rem', letterSpacing: '0.06em', color: '#1a2d4a', lineHeight: 1.3, margin: 0 }}>
              SERVING SAINT CLOUD<br />LAKE NONA • NARCOOSSEE<br />&amp; SURROUNDING AREAS
            </p>
          </div>
